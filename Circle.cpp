...
namespace mfem{
  ...
  Circle::Circle(ParFiniteElementSpace &h1_fes, ParFiniteElementSpace &l2_fes): AnalyticalGeometricShape(h1_fes, l2_fes), radius(0.11), center(2)
 {
   center(0) = 0.5;
   center(1) = 0.5;
  }
  ...
  void Circle::ComputeDistanceAndNormalAtQuadraturePoints(const IntegrationRule &b_ir, Array<int> &elemStatus, Array<int> &faceTags, DenseMatrix &quadratureDistance, DenseMatrix &quadratureTrueNormal, DenseMatrix &quadratureDistance_BF,  DenseMatrix &quadratureTrueNormal_BF){
