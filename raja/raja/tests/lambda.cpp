...
bool lambdaTest(ParMesh *pmesh, const int order_v, const int max_step)
{
   ...
   RajaFiniteElementSpace H1compFESpace(H1FESpace.GetParMesh(), H1FESpace.FEColl(),
                                        1);
   ...
   const IntegrationRule &integ_rule=IntRules.Get(
                                        H1FESpace.GetMesh()->GetElementBaseGeometry(0),
   ...
   const int vlsize = nzones * H1compFESpace.GetLocalDofs() *
