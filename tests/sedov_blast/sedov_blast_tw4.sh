...
case $testtype in
  offline)
    ./laghos -m "$BASE_DIR"/data/cube01_hex.mesh -pt 211 -tf 0.01 -offline -ef 0.9999 -normtype "$normtype" -nwin 4 -tw "$BASE_DIR"/tests/sedov_blast/tw4sedov_blast.csv -writesol -romsvds
    ;;
  online)
