...
int ReadTimeWindows(const int nw, std::string twfile, Array<double>& twep)
{
    cout << "Reading time windows from file " << twfile << endl;
    ...
    while (getline(ifs, line))
    {
        ...
        cout << "Using time window " << count << " with end time " << twep[count] << endl;
        count++;
    }
...
int ReadTimeWindowParameters(const int nw, std::string twfile, Array<double>& twep, Array2D<int>& twparam)
{
    cout << "Reading time window parameters from file " << twfile << endl;
    ...
    while (getline(ifs, line))
    {
        ...
        cout << "Using time window " << count << " with end time " << twep[count] << ", rdimx " << twparam(count,0)
