...
namespace mfem {
  ...
  private:
    double t;
  public:
    explicit CudaTimeDependentOperator(int n = 0, double t_ = 0.0) : CudaOperator(n), t(t_) {}
  ...
  public:
    ...
    CudaRAPOperator(const CudaOperator &Rt_, const CudaOperator &A_, const CudaOperator &P_)
