...
case $subTestNum in
  ...
  2)
    ...
    ;;
  3)
    $LAGHOS -m data/cube01_hex.mesh -pt 211 -tf 0.01 -online -romgs -romhrprep -nwin 4 -twp twpTemp.csv -no-romsns -romos -hrsamptype sopt
    $LAGHOS_SERIAL -m data/cube01_hex.mesh -pt 211 -tf 0.01 -online -romgs -romhr -nwin 4 -twp twpTemp.csv -no-romsns -romos -hrsamptype sopt
    ;;
  4)
