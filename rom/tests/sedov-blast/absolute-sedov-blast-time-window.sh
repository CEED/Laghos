...
case $subTestNum in
  1)
    ...
    ;;
  2)
    $LAGHOS -m data/cube01_hex.mesh -pt 211 -tf 0.4 -online -romhrprep -nwin 4 -soldiff -rostype load
    $LAGHOS_SERIAL -m data/cube01_hex.mesh -pt 211 -tf 0.4 -online -romhr -nwin 4 -soldiff -rostype load
    ;;
esac
