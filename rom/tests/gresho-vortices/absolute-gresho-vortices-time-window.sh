...
case $subTestNum in
  1)
    ...
    ;;
  2)
    $LAGHOS -p 4 -m data/square_gresho.mesh -rs 3 -ok 3 -ot 2 -tf 0.62 -s 7 -online -romhrprep -soldiff -romsvds -nwin 4 -sfacx 35 -sfacv 35 -sface 35 -rostype load
    $LAGHOS_SERIAL -p 4 -m data/square_gresho.mesh -rs 3 -ok 3 -ot 2 -tf 0.62 -s 7 -online -romhr -soldiff -romsvds -nwin 4 -sfacx 35 -sfacv 35 -sface 35 -rostype load
    ;;
esac
