...
> [Reduced order models for Lagrangian hydrodynamics](https://doi.org/10.1016/j.cma.2021.114259). <br>
> *Computer Methods in Applied Mechanics and Engineering*, Volume 388, 2022, Article 114259.
...
You can reach the Laghos ROM team by leaving a
comment in the [issue tracker](https://github.com/CEED/Laghos/issues).

## libROM: library for Reduced Order Model

We rely heavily on the library for reduced order models, [libROM](https://www.libROM.net),
