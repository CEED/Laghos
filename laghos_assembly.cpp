                  ...
                  double* _v)
{
   ...
   DeviceTensor<4> velocity(_v, D1D,D1D,2,NE);
   MFEM_FORALL(e, NE,
   {
      double e_xy[Q1D][Q1D];
                  ...
                  double* _v)
{
   ...
   const double eps1 = numeric_limits<double>::epsilon();
   const double eps2 = eps1*eps1;
   DeviceTensor<5> velocity(_v, D1D,D1D,D1D,3,NE);
   MFEM_FORALL(e, NE,
   {
                           ...
                           double* _e)
{
   ...
   const DeviceTensor<5> sJit(_sJit, Q1D,Q1D,NE,2,2);
   const DeviceTensor<4> velocity(_v, D1D,D1D,2,NE);
                           ...
                           double *_e)
{
   ...
   const DeviceTensor<6> sJit(_sJit, Q1D,Q1D,Q1D,NE,3,3);
   const DeviceTensor<5> velocity(_v, D1D,D1D,D1D,3,NE);
