...
// *****************************************************************************
extern "C" void kInitQuadratureData(const double GAMMA,
                                    const double H0,
                                    const double CFL,
  ...
  for (int el = 0; el < numElements; ++el) {
    for (int q = 0; q < NUM_QUAD; ++q) {
      rho0DetJ0w[ijN(q,el,NUM_QUAD)] = rho0[ijN(q,el,NUM_QUAD)]*detJ[ijN(q,el,NUM_QUAD)]*quadWeights[q];
    }
  }
}

// *****************************************************************************
extern "C" void kUpdateQuadratureData2D(const double GAMMA,
                                        const double H0,
                                        const double CFL,
                                        const bool USE_VISCOSITY,
                                        const int NUM_DIM,
...
// *****************************************************************************
extern "C" void kUpdateQuadratureData3D(const double GAMMA,
                                        const double H0,
                                        const double CFL,
                                        const bool USE_VISCOSITY,
                                        const int NUM_DIM,
